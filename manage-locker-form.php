...
<head>
  ...
  <title>Exxon | Manage Assign Locker</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
<?php $query=mysqli_query($con,"select * from lockers");
$cnt=1;
...
?>
                  ...
                  <tr>
                    ...
                    <td><?php echo $result['andar']?></td>
                    <td><?php echo $result['disponibilidade']?></td>
                    <td><?php echo $result['pessoa']?></td>
                    <th>
